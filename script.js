...
function getShadowParams(){
    ...
    const shadowInsert = document.getElementById("shadow-insert").checked;

    return [hShadow,vShadow,blurRadius,spreadRadius,shadowColor,shadowColorOpacity,shadowInsert]

}

function createBoxShadow(hShadow,vShadow,blurRadius,spreadRadius,color,opacity,insert){

    const shadow = insert ? "insert" : "";
